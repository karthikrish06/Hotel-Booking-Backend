...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="p-4 rounded-lg bg-gray-200 mt-8 shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 
